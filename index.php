...
$(function(){
    $('.edit-btn').click(function(){
        ...
        $.post('',{get_content:f},function(d){
            $('#editModal textarea').val(d); $('#editModal input[name="edit_file"]').val(f); $('#editModal').removeClass('hidden');
        });
    });
    ...
    $('.mtime-btn').click(function(){ 
        let f=$(this).data('file'); let dt=$(this).data('mtime');
        $('#mtimeModal input[name="update_mtime"]').val(f);
        $('#mtimeModal input[name="mtime_value"]').val(dt);
        $('#mtimeModal span').text(f);
        $('#mtimeModal').removeClass('hidden');
    });
